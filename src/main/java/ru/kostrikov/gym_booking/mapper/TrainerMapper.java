...
public interface TrainerMapper {
    ...
    @Mapping(target = "user", expression = "java(ru.kostrikov.gym_booking.mapper.TrainerMapper.INSTANCE.transformUser(entity))")
    @Mapping(target = "presentation", expression = "java(ru.kostrikov.gym_booking.mapper.TrainerMapper.INSTANCE.presentation(entity))")
    ...
    default UserDto transformUser(Trainer entity) {
        return UserMapper.INSTANCE.toDto((ru.kostrikov.gym_booking.entity.User) entity);
    }
